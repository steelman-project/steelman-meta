#!/bin/bash
# Firewall initialization script for containerized execution.
#
# Source: Anthropic's Claude Code reference devcontainer
# https://github.com/anthropics/claude-code/blob/main/.devcontainer/init-firewall.sh
# Vendored from commit: 07e13937b2d6 (2025-08-27)
#
# This script restricts outbound network access to whitelisted domains only.
# It is NOT a hard security boundary — Claude with bypassPermissions can
# modify iptables rules. It is best-effort network hygiene.
